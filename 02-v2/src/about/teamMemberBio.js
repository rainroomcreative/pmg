...
const TeamMemberBio = ({ member, active, onClick }) => {
    ...
    return (
      <div className={"relative flex-col items-center gap-4 my-6 z-40 p-2.5 md:p-6 pointer-events-none bg-white text-black m-h-160 overflow-scroll text-left rounded-3xl" + `${active ? " flex" : " hidden"}`}>
