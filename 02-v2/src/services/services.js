    ...
    return (
        <div className="w-full flex flex-col px-6 py-12 container mx-auto">
            ...
            <div className="flex flex-col text-white gap-9 justify-center align-center lg:flex-row">
                <div className="bg-blue px-5 py-6 rounded-3xl flex flex-col justify-start relative align-center gap-6 service-card h-52 hover:h-80 lg:w-1/4 lg:h-60 transition-all duration-500">
