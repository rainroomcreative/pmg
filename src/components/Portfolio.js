...
const Portfolio = () => {
    return ( 
         <div className="container">
                  <div className="row porfolio-row justify-content-center">
                        <div className=" col-xs col-sm col-md col-lg col-xl portfolio-col">
                              <h1 className="portfolio-content" id="port">Portfolio</h1>
                        </div>
                  </div>
                  <Fade right duration={1000}>
                  <div className="row pilot-row justify-content-center">
                        <div  className=" col-xs col-sm col-md col-lg col-xl text-center" id="portfolio-one">
                        <a id="pilot-link" href="https://www.02pilot.com" target="_blank" rel="noreferrer" >
                              <img src="https://res.cloudinary.com/dyew1z2ms/image/upload/v1606430218/Portfolio/02pilot_jrdoxn.png" className="img-fluid round" alt="first portfolio logo" height="200" width="400" id="portfolio-one-image" />
                        </a>
                  </div>
                ...
                <Fade right duration={1000} delay={400}>
                  <div className="row new-row">
                        <div   id="portfolio-two" className="col-xs col-sm col-md col-lg col-xl portfolio-move text-center">
                        <a id="new-link" href="https://www.thehhmp.org" target="_blank" rel="noreferrer">
                 ...
                 <Fade right duration={1000} delay={750}>
                    <div className="row davie-row">
                        <div  id="portfolio-six"
                              className=" col-xs col-sm col-md col-lg col-xl portfolio-move text-center">
                ...
                <Fade right duration={1000} delay={500}>
                 ...
                 <Fade right duration={1000} delay={650}> 
                     <div className="row broadway-row">
                        <div   id="portfolio-four"
                         className=" col-xs col-sm col-md col-lg col-x portfolio-move text-center">
                 ...
                 <Fade duration={1000} delay={700}> 
                    <div className="row coffee-row">
                        <div id="portfolio-five" className=" col-xs col-sm col-md col-lg col-xl portfolio-move text-center">
                  ...
                  <div id="portfolio-seven" className="col-xs col-sm col-md col-lg col-xl portfolio-move text-center">
