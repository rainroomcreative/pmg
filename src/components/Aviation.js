...
<div className="container">
  ...
  <section id="table-section">
    <div className="row time-row" id="time-row-id">
      <table className="container col-xs col-sm col-md col-lg col-xl table-responsive time-container" id="time-container-id">
        <thead >
          <tr >
            <th>
            </th>
    ...
    <div className="row rating-row" id="rating-row-id">
