...
const Value = () => {
    ...
    return (
        ...
        <div className="w-screen">
            <div className="w-screen h-max flex flex-col gap-12 relative">
                ...
                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(0) : console.log("not in view")} className="max-h-[700px] h-screen flex flex-row justify-center items-start hourglass h-full bg-red-500 basis-9/12 flex-1 text-left text-white value-text-box w-full" id="time">
                    <div className="w-1/2 max-h-[700px] h-screen bg-blue flex flex-col justify-center rounded-e-[20px] pl-40 pr-20" id="valueScrollController">
                    ...
                    <div className="w-1/2 max-h-[700px] h-screen overflow-scroll hide-scroll rounded-e-[20px]">
                ...
                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(1) : console.log("not in view")} className="max-h-[700px] h-screen flex flex-row justify-center items-start hourglass h-full bg-red-500 basis-9/12 flex-1 text-left text-white value-text-box w-full" id="profits">
                    <div className="w-1/2 max-h-[700px] h-screen bg-blue flex flex-col justify-center rounded-e-[20px] pl-40 pr-20" id="valueScrollController">
                ...
                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(2) : console.log("not in view")} className="max-h-[700px] h-screen flex flex-row justify-center items-start hourglass h-full bg-red-500 basis-9/12 flex-1 text-left text-white value-text-box w-full" id="workSmarter">
                    <div className="w-1/2 max-h-[700px] h-screen bg-blue flex flex-col justify-center rounded-e-[20px] pl-40 pr-20" id="valueScrollController">
                ...
                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(3) : console.log("not in view")} className="max-h-[700px] h-screen flex flex-row justify-center items-start hourglass h-full bg-red-500 basis-9/12 flex-1 text-left text-white value-text-box w-full" id="professionals">
                    <div className="w-1/2 max-h-[700px] h-screen bg-blue flex flex-col justify-center rounded-e-[20px] pl-40 pr-20" id="valueScrollController">
