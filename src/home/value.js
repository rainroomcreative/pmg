    ...
    return (
        <div className="w-screen snap-start px-6 md:px-0" >
            <div className="md:pr-6 py-20 font-bold text-blue md:relative text-left flex gap-36 flex-col justify-between items-center w-full md:h-full md:gap-4">
                ...
                <div className="sticky left-0 top-0 flex-col justify-center self-start pl-8 text-left w-1/2 h-screen bg-blue hidden md:flex rounded-e-[20px]">
                </div>

                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(0) : console.log("not in view")} className="hourglass value-text-box flex flex-col md:flex-row-reverse md:gap-10 py-10 md:mt-[-90vh] justify-end md:justify-center md:justify-between items-center min-h-screen relative snap-center" id="time">
                    <div className="flex flex-col items-center mx-auto md:mx-0 bg-hourglass bg-bottom bg-center bg-[length:450px] md:bg-[length:100%] bg-no-repeat max-h-full w-full md:w-1/2 md:max-w-[430px] absolute md:relative top-0 z-0">
                        <Parallax translateY={[-20, 15]}>
                            <img src={Hourglass} alt="Get your time back" className="mx-auto max-w-[450px] md:mx-w-[auto]" />
                        </Parallax>
                    </div>
                    <div className="z-10 md:z-0 flex flex-col justify-end md:justify-center items-start h-full md:min-h-[80vh] md:w-1/2 md:text-white md:pr-28 md:pl-40">
                ...
                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(1) : console.log("not in view")} className="money value-text-box flex flex-col md:flex-row-reverse md:gap-10 justify-end md:justify-center md:justify-between py-10 items-center relative min-h-screen snap-always snap-center" id="profits">
                    <div className="flex flex-col items-center mx-auto md:mx-0 bg-money bg-no-repeat bg-center bg-[length:450px] md:bg-[length:100%] w-full md:w-1/2 md:max-w-[430px] max-h-full absolute md:relative top-0 z-0" style={{height: 78 + 'vh'}}>
                        <Parallax translateY={[-45,  25]} className="absolute top-4 z-20">
                            <img src={Money3} alt="Get your time back" className="mx-auto max-w-[450px] md:mx-w-[auto]" />
                        </Parallax>
                        <Parallax translateY={[-35, 20]} className="absolute top-4 z-10">
                            <img src={Money2} alt="Get your time back" className="mx-auto max-w-[450px] md:mx-w-[auto]" />
                        </Parallax>
                        <Parallax translateY={[-25, 0 ]} className="absolute top-12 z-0">
                            <img src={Money1} alt="Get your time back" className="mx-auto max-w-[450px] md:mx-w-[auto]" />
                        </Parallax>
                    </div>
                    <div className="z-10 md:z-0 relative top-48 md:top-0 pb-48 md:pb-0 flex flex-col justify-end md:justify-center md:min-h-[80vh] items-start h-full md:w-1/2 md:text-white md:pr-28 md:pl-40">
                ...
                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(2) : console.log("not in view")}  className="lightbulb value-text-box flex flex-col md:flex-row-reverse md:gap-10 justify-end md:justify-center md:justify-between py-10 items-center min-h-screen relative snap-always snap-center" id="workSmarter">
                    <div className="flex flex-col items-center mx-auto md:mx-0 bg-lightbulb bg-bottom bg-center bg-[length:450px] md:bg-[length:100%] bg-no-repeat max-h-full w-full md:w-1/2 md:max-w-[430px] absolute md:relative top-0 z-0">
                        <Parallax translateY={[-20, 15 ]}>
                            <img src={Lightbulb} alt="Lightbulb" className="mx-auto max-w-[450px] md:mx-w-[auto]" />
                        </Parallax>
                ...
                <InView as="div" threshold={.8} onChange={(inView, entry) => inView ? handleProgress(3) : console.log("not in view")}  className="flex flex-col md:flex-row-reverse md:gap-10 justify-end md:justify-center md:justify-between py-10 items-center relative min-h-screen snap-always snap-center gears value-text-box" id="professionals">
                    <div className="flex flex-col items-center mx-auto md:mx-0 bg-gears bg-no-repeat bg-center bg-[length:450px] md:bg-[length:100%] w-full md:w-1/2 md:max-w-[430px] max-h-full absolute md:relative top-0 z-0" style={{height: 78 + 'vh'}}>
                        <Parallax translateY={[-35, 25]} className="absolute top-4 z-10">
                            <img src={Gears2} alt="Gears" className="mx-auto max-w-[450px] md:mx-w-[auto]" />
                        </Parallax>
                        <Parallax translateY={[-20, 0 ]} className="absolute top-20 z-0">
                            <img src={Gears1} alt="Gears" className="mx-auto max-w-[450px] md:mx-w-[auto]" />
                        </Parallax>
                    </div>
                    <div className="z-10 md:z-0 relative top-48 md:top-0 pb-48 md:pb-0 flex flex-col justify-end md:justify-center items-start h-full md:min-h-[80vh] md:w-1/2 md:text-white md:pr-28 md:pl-40">
